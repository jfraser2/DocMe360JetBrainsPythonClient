...
class TemplateControllerApi:
    ...
    def all_templates(
        ...
        _param = self._all_templates_serialize(
    ...
    @validate_call
    def all_templates_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def all_templates_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _all_templates_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/all/templates',
    ...
    def create_template(
        ...
        :param create_template: (required)
        :type create_template: CreateTemplate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _create_template_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/createTemplate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def find_by_template_id(
        ...
        _param = self._find_by_template_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def find_by_template_id_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def find_by_template_id_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _find_by_template_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/findByTemplateId/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_template(
        ...
        :param update_template: (required)
        :type update_template: UpdateTemplate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _update_template_serialize(
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/v1/updateTemplate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
